...
<div id="headlines">
  ...
  <div id="refer">
  <p>
   1&nbsp;-&nbsp;An algorithmic framework for convex MINLP. Bonami et.al.
   <a href="http://domino.research.ibm.com/library/cyberdig.nsf/1e4115aea78b6e7c85256b360066f0d4/fdb4630e33bd2876852570b20062af37?OpenDocument">
   full reference</a>
  </p>
  </div>
  <div id="refer">
  <p>
  2&nbsp;-&nbsp;An outer-approximation algorithm for a class of MINLP. M.&nbsp;Duran and I.E.&nbsp;Grossmann. Mathematical Programming
  <a href="BONMIN_UsersManual.html#DG">full reference</a>
</p>
</div>
  <div id="refer">
   <p>
   3&nbsp;-&nbsp;Branch and bound experiments in convex nonlinear integer programming. O.K.&nbsp;Gupta and V.&nbsp;Ravindran.
   <a href="BONMIN_UsersManual.html#Gupta80Nonlinear">full reference</a>
  </p>
  </div>
  <div id="refer">
  <p>
  4&nbsp;-&nbsp;Solving MINLP by outer approximation.
  R.&nbsp;Fletcher and S.&nbsp;Leyffer. Mathematical Programming.
  <a href="http://dx.doi.org/10.1007/BF01581153">full reference</a>
  </p>
  </div>
  <div id="refer">
   An LP/NLP based branched and bound algorithm for convex MINLP optimization problems. I.&nbsp;Quesada and I.E.&nbsp;Grossmann.
   Computers and Chemical Engineering
   <a href="http://dx.doi.org/10.1016/0098-1354(92)80028-8">full reference</a>
  </div>
</div>
<!--end headlines -->
\end{rawhtml}
...
\PageTitle{Introduction}{sec:Intro}
...
\COINOR
\mylatexhtml{\begin{latexonly} (\tt www.coin-or.org) \end{latexonly}}{}
...
\link{http://www.ilog.com/products/cplex/product/mip.cfm}{\tt Cplex}
...
algorithm
\citeH{QG}{http://dx.doi.org/10.1016/0098-1354(92)80028-8}{5}
...
and some details of their implementations can be found in\citeH{Betal}{http://domino.research.ibm.com/library/cyberdig.nsf/1e4115aea78b6e7c85256b360066f0d4/fdb4630e33bd2876852570b20062af37?}{1}.
...
\begin{itemize}
\item \link{http://www.netlib.org/lapack/}{Lapack} (Linear Algebra
PACKage)
\item \link{http://www.netlib.org/blas/}{Blas} (Basic Linear Algebra
Subroutines)
\item the sparse linear solver MA27 from the
\link{http://www.cse.clrc.ac.uk/nag/hsl/contents.shtml}{HSL}
...
the commercial solver \footlink{http://www.ilog.com/products/cplex/product/mip.cfm}{\tt Cplex}.
