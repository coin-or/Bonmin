...
\end{verbatim}
\end{latexonly}
\begin{htmlonly} \link{http://www.coin-or.org/Bonmin}{homepage} 
and \link{https://projects.coin-or.org/Bonmin}{wiki}. \end{htmlonly}
...
{[\link{\DGLink}{Duran Grossmann 1986},\link{\FLLink}{Fletcher Leyffer 1994}]}
...
\item {\tt B-iFP}: an iterated feasibility pump algorithm \citeH{bonami.etal:06}{\FPLink}{Bonami Cornu\'ejols Lodi Margot 2009}.
\end{itemize}

In this manual,  we will not go into a further description of these algorithms.
Mathematical details of these algorithms 
and some details of their implementations can be found in \citeH{Betal}{\BetalLink}{Bonami et al. 2008}
and \citeH{hot:2009}{\HotMINLPLink}{Bonami K\i ln\i c Linderoth 2009}.
