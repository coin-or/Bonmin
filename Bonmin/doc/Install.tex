...
\begin{quickref}
\quickcitation{Generic Coin Installation on Coin BuildTools web page}{\CoinLink BuildTools}
\quickcitation{Known issues for building Coin packages}{\CoinLink BuildTools}
\quickcitation{\Bonmin\ build Wiki page.}{\CoinLink Bonmin/wiki/GettingStarted}
\quickcitation{Specific Instructions for building \Bonmin\ on Cygwin}{\CoinLink Bonmin/Wiki/CygwinInstall}
\quickcitation{Specific instructions for building \Bonmin\ on Mac OSX}{\CoinLink Bonmin/Wiki/OsXInstall}
\end{quickref}
