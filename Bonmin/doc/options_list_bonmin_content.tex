...
<tr>   <th colspan=7> <a href="#sec:Bonmin_algorithm_choice">Bonmin algorithm choice</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_branch-and-bound_options">bonmin branch-and-bound options</a> </th>
</tr>
<tr>
...
<tr>
<td> <a href="#sec:branch_pt_select">branch_pt_select</a> </td>
<td>S</td>
<td>mid-point</td>
<td> +</td>
<td>+</td>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_nlp_interface_option">bonmin nlp interface option</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_options_:_Nlp_solve_options">bonmin options : Nlp solve options</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_options_:_Options_for_MILP_subsolver_in_OA_decomposition">bonmin options : Options for MILP subsolver in OA decomposition</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_options_:_Options_for_OA_decomposition">bonmin options : Options for OA decomposition</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_options_:_Options_for_ecp_cuts_generation">bonmin options : Options for ecp cuts generation</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_options_:_Outer_Approximation_cuts">bonmin options : Outer Approximation cuts</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_options_for_MILP_cutting_planes">bonmin options for MILP cutting planes</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:bonmin_output_options">bonmin output options</a> </th>
</tr>
<tr>
...
\subsection{Bonmin algorithm choice}
...
\subsection{bonmin nlp interface option}
...
\subsection{bonmin options : Nlp solve options}
...
\subsection{bonmin options : Options for MILP subsolver in OA decomposition}
...
\subsection{bonmin options : Options for OA decomposition}
...
\subsection{bonmin options : Options for ecp cuts generation}
...
\subsection{bonmin options : Outer Approximation cuts}
...
\subsection{bonmin options for MILP cutting planes}
...
\paragraph{Gomory\_cuts:} Frequency k (in terms of nodes) for generating Gomory cuts in branch-and-cut. $\;$ \\
 If k > 0, cuts are generated every k nodes, if
-99 < k < 0 cuts are generated every -k nodes but
Cbc may decide to stop generating cuts, if not
enough are generated at the root node, if k=-99
