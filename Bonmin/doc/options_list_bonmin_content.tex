...
<tr>   <th colspan=7> <a href="#sec:Feasibility_pump_heuristic">Feasibility pump heuristic</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:Fractional_diving_MIP_heuristic">Fractional diving MIP heuristic</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:Fractional_diving_heuristic">Fractional diving heuristic</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:Local_search_based_heuristics">Local search based heuristics</a> </th>
</tr>
<tr>
<td> <a href="#sec:dummy_pump_heuristic">dummy_pump_heuristic</a> </td>
<td>S</td>
<td>no</td>
<td> +</td>
<td>+</td>
...
<tr>
<td> <a href="#sec:fix_and_solve_heuristic">fix_and_solve_heuristic</a> </td>
<td>S</td>
<td>no</td>
<td> +</td>
<td>+</td>
...
<tr>
<td> <a href="#sec:heuristic_local_branching">heuristic_local_branching</a> </td>
<td>S</td>
<td>no</td>
<td> +</td>
<td>+</td>
...
<tr>   <th colspan=7> <a href="#sec:VectorLength_diving_MIP_heuristic">VectorLength diving MIP heuristic</a> </th>
</tr>
<tr>
...
<tr>   <th colspan=7> <a href="#sec:VectorLength_diving_heuristic">VectorLength diving heuristic</a> </th>
</tr>
<tr>
...
\subsection{Feasibility pump heuristic}
\label{sec:Feasibility_pump_heuristic}
...
\subsection{Fractional diving MIP heuristic}
\label{sec:Fractional_diving_MIP_heuristic}
...
\subsection{Fractional diving heuristic}
\label{sec:Fractional_diving_heuristic}
...
\subsection{Local search based heuristics}
\label{sec:Local_search_based_heuristics}
\paragraph{dummy\_pump\_heuristic:}\label{sec:dummy_pump_heuristic} if yes runs a heuristic which looks like a dummy FP $\;$ \\
...
\paragraph{fix\_and\_solve\_heuristic:}\label{sec:fix_and_solve_heuristic} if yes runs a heuristic at root where fixes all variables integer in the continuous solution $\;$ \\
...
\paragraph{heuristic\_local\_branching:}\label{sec:heuristic_local_branching} if yes runs the LocalBranching heuristic $\;$ \\
...
\subsection{VectorLength diving MIP heuristic}
\label{sec:VectorLength_diving_MIP_heuristic}
...
\subsection{VectorLength diving heuristic}
\label{sec:VectorLength_diving_heuristic}
