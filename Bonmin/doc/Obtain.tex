...
The easiest way to obtain the released version is by downloading a compressed archive from \link{http://www.coin-or.org/Tarballs/Bonmin/}{Bonmin archive directory}. The latest release is Bonmin-\releaseVersion.
...
Linear solvers are used by Ipopt. The most up-to-date information regarding the supported linear solvers and how to install them is found in \link{http://www.coin-or.org/Ipopt/documentation/node15.html}{Section 2.2} of the Ipopt manual.\\
