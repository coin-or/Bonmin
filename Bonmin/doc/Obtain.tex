...
The easiest way to obtain the released version is by downloading a compressed archive from \link{http://www.coin-or.org/Tarballs/Bonmin/}{Bonmin archive directory}. The latest release is Bonmin-0.1.4.
