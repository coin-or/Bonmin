...
\subsectionH{\Bonmin\  output options}{}
...
\subsectionH{\Bonmin\ branch-and-bound options}
...
and its default value is ${\tt 10^{-06}}$.
...
\subsectionH{\Bonmin\ options for non-convex problems}{}
...
\subsectionH{\Bonmin\ options : {\tt B-Hyb} specific options}
