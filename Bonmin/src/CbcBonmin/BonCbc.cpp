...
BONMINLIB_EXPORT Bonmin::OACutGenerator2 * currentOA = NULL; //pointer to the OA generator
BONMINLIB_EXPORT CbcModel * OAModel; // pointer to the submip if using Cbc
bool BonminAbortAll;
