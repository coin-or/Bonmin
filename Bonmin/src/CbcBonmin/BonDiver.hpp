...
namespace Bonmin
{
  ...
  public:
    ...
    virtual int size()
    {
      return ((int) nodes_.size() + (nextOnBranch_ != NULL) );
    }
    /** @} */
  ...
  /** Class to do probed diving in the tree.
    * Principle is that branch-and-bound follows current branch of the tree by exploring the two childs at each level
  ...
  public:
    ...
    virtual int size()
    {
      return ((int) nodes_.size() + (nextOnBranch_ != NULL) + (candidateChild_ != NULL) );
    }
    /** @} */
  ...
  public:
    ...
    virtual int size()
    {
      return (int) nodes_.size() + diveListSize_;
    }
    /** @} */
