 ...
 * Purpose: return branch gain and branch object for 1/x
 *
...
double exprInv::BranchGain (expression *w, const OsiBranchingInformation *info) {
...
OsiBranchingObject *exprInv::BranchObject (expression *w, const OsiBranchingInformation *) {
